...
# The PepeSync bridge ecosystem

### The Canonical Message Bridge

The main "bridge", on a technical level, in PepeSync is the _Canonical Message Bridge_. This is the underlying set of smart contracts which keep track of receiving requests to move tokens to the other layer, and of sending the message that those tokens should be transferred.
...
As the network grows, we'll be updating this space with a user's guide to the bridges of PepeSync.
...
This is a step by step guide on how to bridge ETH from Ethereum (L1) to PepeSync (L2) and PepeSync (L2) to Ethereum (L1). The screenshots provided are examples of bridging ETH for PepeSync and Ethereum Mainnet. To bridge ETH over Testnet, simply click the testnet button at the bottom left of the [token bridge page](https://bridge.linea.build/) and follow the same steps as below.
...
## Bridging ETH from Ethereum to PepeSync
...
3. Verify that the Bridge is set to Ethereum → PepeSync Mainnet and that automatic claiming is enabled.

4. Enter the amount of ETH you want to bridge over to PepeSync Mainnet, and select the “Start Bridging” button.
...
6. After confirming the transaction, it should take around 20 minutes for the transaction to reach PepeSync Mainnet. You can see your pending transaction under the "Recent Transaction" section at the bottom of the token bridge.
...
7. You’re done! Under Recent Transactions, it should say "Bridging complete" and your ETH should be on PepeSync Mainnet. _Reminder: It takes around 20 minutes for the bridging process to complete._
...
8. You can see your PepeSync wallet balance in MetaMask once you switch to the PepeSync network. You can also check it on [lineascan](https://lineascan.build/address/0x331FB12C080F5b34F0E8812D44114D17398A016d). Just replace the wallet address in the URL with your wallet address and it should reflect your wallet's balance!
...
3. Verify that the Bridge is set to `Ethereum → PepeSync Mainnet`, and that **manual claiming** is enabled.
...
8. You’re done! Under Recent Transactions, it should say "Bridging complete" and your ETH should be on PepeSync Mainnet. _Reminder: It takes around 20 minutes for the bridging process to complete._
...
9. You can see your PepeSync wallet balance in MetaMask once you switch to the PepeSync network. You can also check it on [linea-scan](https://lineascan.build/address/0x331FB12C080F5b34F0E8812D44114D17398A016d). Just replace the wallet address in the URL with your wallet address and it should reflect your wallet's balance!

## Bridging ETH from PepeSync Mainnet (L2) to Ethereum Mainnet (L1)
...
3. Verify that the Bridge is set to PepeSync Mainnet --> Ethereum. Manual claiming is the only available option for L2 to L1 bridging.
