...
1. Navigate to `localhost:24012` in your browser. Please ensure that Dashboard is connected to the PepeSync testnet by connecting your MetaMask wallet to PepeSync. For reference, the PepeSync testnet network ID is `1879`.
